		...
		<div class="auth">
			<?php
				...
				if (isset($_SESSION['logged_user'])){
					...
					print('<div class="info"><span">Привет, '.$name.'</span>');
					print('<a href="/test-php-project/logout.php">выход</a>');
					print('<a href="/test-php-project/changename.php">изменить данные</a></div>');
				} else {
					// для не залогиненного:
					print('<div class="info"><span>Привет гость!</span>');
					print('<a href="signin.php">войти</a>');
					print('<a href="signup.php">регистрация</a></div>');
				}
